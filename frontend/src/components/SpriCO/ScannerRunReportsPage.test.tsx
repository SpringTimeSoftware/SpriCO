...
describe('ScannerRunReportsPage', () => {
  ...
  it('lists completed no-finding scanner runs and opens a detailed report', async () => {
    ...
    expect(screen.getByText(/Scan completed with no actionable findings/)).toBeInTheDocument()
    expect(screen.getByText(/No Evidence Center records were created/)).toBeInTheDocument()
